#
# Module manifest for module 'PSDockerHub'
#
# Generated by: beatcracker
#
...
TypesToProcess = @('.\TypeData\PSDockerHub.Types.ps1xml')

# Format files (.ps1xml) to be loaded when importing this module
FormatsToProcess =  @('.\TypeData\PSDockerHub.Format.ps1xml')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('Docker', 'Hub', 'Container', 'API', 'Find', 'Search')

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/beatcracker/PSDockerHub/blob/master/License'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/beatcracker/PSDockerHub'
